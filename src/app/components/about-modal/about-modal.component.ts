...
@Component({
  ...
  template: `
    <div *ngIf="isOpen" 
      ...
      <div #modalContainer class="mac-window bg-white p-5 w-full max-w-md shadow-2xl space-y-4 border-2 border-black">
        
        <!-- Mac OS About Header -->
        <div class="flex items-center space-x-3 border-b-2 border-black pb-3">
          <div class="w-10 h-10 bg-black text-white border-2 border-black flex items-center justify-center text-xl font-bold font-mono shadow-sm"></div>
          <div>
            <h2 [id]="titleId" class="font-bold text-xs uppercase tracking-wider text-black">About PowerPC Bit-Hacks Utility</h2>
            <div class="text-[10px] font-mono text-gray-600">System 7 Macintosh Desktop Environment (1996/1997)</div>
          </div>
        </div>
        ...
        <div class="space-y-3 text-xs font-mono">
          <div class="mac-inset p-3 bg-amber-50/40 space-y-1.5 text-[11px]">
            <div class="font-bold text-black border-b border-gray-300 pb-1">Hardware & Emulation Context</div>
          ...
          <div class="bg-white p-3 border border-black space-y-1.5">
            <div class="font-bold text-black flex items-center justify-between text-[11px] border-b border-gray-200 pb-1">
