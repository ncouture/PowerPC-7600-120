...
@Component({
  ...
  template: `
    <div
      class="fixed inset-0 bg-black z-[500] flex flex-col items-center justify-center p-6 select-none font-mono text-white"
    >
      ...
      <div class="flex flex-col items-center space-y-6 max-w-lg text-center z-10">
        ...
        <div
          class="space-y-1 bg-white text-black px-4 py-2 border-2 border-black font-bold text-sm tracking-widest font-mono shadow-md"
        >
          <div>0000000F</div>
          <div>00000003</div>
        </div>
        ...
        <div class="space-y-2 text-xs font-mono text-gray-300">
          <p class="font-bold text-red-400 uppercase tracking-wider">
            System Error: Hardware ROM / PowerPC Bus Exception
          </p>
          <p class="text-gray-400 text-[11px]">
            The Macintosh System 7 Toolbox encountered an unrecoverable hardware exception during
            startup routine.
          </p>
        </div>
