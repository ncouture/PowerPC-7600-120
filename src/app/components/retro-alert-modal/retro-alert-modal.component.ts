...
@Component({
  ...
  template: `
    <div *ngIf="isOpen" 
      ...
      <div #modalContainer class="mac-window bg-white p-4 w-80 shadow-2xl space-y-3 border-2 border-black">
        <div class="flex items-center space-x-2 border-b-2 border-black pb-2">
          <div class="text-lg">💻</div>
          <div [id]="titleId" class="font-bold text-xs uppercase tracking-wide">System Notice</div>
        </div>
